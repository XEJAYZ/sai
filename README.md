  ...
  <script>
    ...
    yesButton.addEventListener("click", function () {
      document.body.innerHTML =
        "<h1>💖 เย้! เบบี๋กดแล้วววววว! เปลี่ยนใจไม่ได้แล้วนะครับ 💖<br>เราคบกันมา 1 เดือนแล้วนะคะ ขอบคุณที่อยู่ด้วยกันนะเบบี๋ รักนะเว้ย!!!!</h1><img src='your-cat-image.png' alt='Cat' width='200'>";
    });
  </script>
</body>
</html>
