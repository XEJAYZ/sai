  ...
  <script>
    ...
    yesButton.addEventListener("click", function () {
      document.body.innerHTML =
        "<h1>💖 เย้! ทรายกดแล้วววววว! เปลี่ยนใจไม่ได้แล้วนะครับ 💖<br>เราครบ 1 เดือนแล้วนะคะ ขอบคุณที่อยู่ด้วยกันนะเบบี๋ 🥰</h1><img src='your-cat-image.png' alt='Cat' width='200'>";
    });
  </script>
</body>
</html>
